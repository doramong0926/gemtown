...
const MusicSocialMediaTable = (props, context) => (
    <div className={styles.RootDivision}>
        <RenderSocialMedia />
    </div>
)

const RenderSocialMedia = (props, context) => {
    return (
...
MusicSocialMediaTable.propTypes = {
}

MusicSocialMediaTable.contextTypes = {
    t: PropTypes.func.isRequired
};

RenderSocialMedia.contextTypes = {
    t: PropTypes.func.isRequired
};
...
export default MusicSocialMediaTable;
