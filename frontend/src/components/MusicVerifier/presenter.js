                ...
                <div className={styles.BlockchainInfoDivision}>
                    ...
                    <div className={styles.InnerDivision}>
                        ...
                        <div className={styles.RightDivision}>
                        {
                            ...
                            (
                                <a 
                                    href={`https://ropsten.etherscan.io/tx/${props.db_music.blockchain_txid}`} 
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={styles.TxidText}
                                >
                                    {props.db_music.blockchain_txid}
                                </a>
                            ) :
                            (
                                <a 
                                    href={`https://etherscan.io/tx/${props.db_music.blockchain_txid}`} 
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className={styles.TxidText}
                                >
...
const RenderMusicInfo = (props, context) => {
    if (props.db_music === undefined || props.db_music === null) {
        return (
            <div className={styles.InnerDivision}>
                <div className={styles.LeftDivision}>
                    <p className={styles.Text}>
        ...
        return (
            <React.Fragment>
                <div className={styles.InnerDivision}>
                    ...
                    <div className={styles.RightDivision}>
                        <p className={styles.Text}>{props.db_music.musician.nickname}</p>
                    </div>
                </div>
                <div className={styles.InnerDivision}>
                    <div className={styles.LeftDivision}>
                        <p className={styles.Text}>
                            {context.t("Music Title")}
                        </p>
                    </div>
                    <div className={styles.RightDivision}>
                        <p className={styles.Text}>{props.db_music.title}</p>
                    </div>
                </div>
            </React.Fragment>
        )
...
const RenderSubmitButton = (props, context) => {
    return (
        <div className={styles.SubmitDivision}>
            <Button 
                disabled={props.selected_music_file === null || props.selected_music_file === undefined}
...
MusicVerifier.propTypes = {
    ...
    db_music: PropTypes.object,
    blockchain_metadata: PropTypes.object,
}

MusicVerifier.contextTypes = {
